...
export interface ApiNetmwEventTypeNetmwEventType
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    netmw_events: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNetmwEventNetmwEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ExternalUrlText: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    netmw_event_type: Schema.Attribute.Relation<
      'manyToOne',
      'api::netmw-event-type.netmw-event-type'
    >;
    PublishDate: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiNetmwRoleNetmwRole extends Struct.CollectionTypeSchema {
...
export interface ApiNetmwTutorialTagNetmwTutorialTag
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    netmw_tutorials: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiNetmwTutorialNetmwTutorial
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    netmw_roles: Schema.Attribute.Relation<
      'oneToMany',
      'api::netmw-role.netmw-role'
    >;
    netmw_tutorial_categories: Schema.Attribute.Relation<
      'oneToMany',
      'api::net-mw-tutorial-category.net-mw-tutorial-category'
    >;
    netmw_tutorial_tags: Schema.Attribute.Relation<
      'manyToMany',
      'api::netmw-tutorial-tag.netmw-tutorial-tag'
    >;
    publishedAt: Schema.Attribute.DateTime;
